...
from utils_vad import get_speech_timestamps, save_audio, read_audio, VADIterator, collect_chunks
...
class silero_vad():
	...
	def __init__(self,
				 ...
				 verbose: bool = True,
				 vad_chunk: int = 5, #0.1 sec = 100ms
				 vad_hop: int = 5, #0.1 sec = 100ms
	...
	def load_model(self):
		...
		model = torch.jit.load("/home/users/ntu/kshitij0/FYP/vad/code_and_model/egs/silero_vad/silero_vad.jit")
...
if __name__ == '__main__':
	...
	for source in glob(os.path.join(args.input_wav, "*.flac")):
		t0 = time.time()
	...
	print('======================== Results ========================')
	print('VAD threshold: ', vad.vad.threshold)
